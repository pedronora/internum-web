<template>
    <section class="d-flex align-items-center justify-content-center my-login-section">
        <div class="row d-flex justify-content-center align-items-center h-100">
            <div class="col-md-9 col-lg-6 col-xl-5 d-none d-md-block">
                <img src="https://mdbcdn.b-cdn.net/img/Photos/new-templates/bootstrap-login-form/draw2.webp"
                    class="img-fluid" alt="Ilustração" />
            </div>
            ...
            <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
                <form @submit.prevent="onSubmit" novalidate>
                    ...
                    <div class="form-outline mb-4">
                        <input id="emailInput" type="text" class="form-control form-control-lg"
                            placeholder="Insira o seu usuário" v-model.trim="username" :disabled="loading" required
                    ...
                    <div class="d-flex align-items-center justify-content-center text-lg-start mt-4 pt-2">
