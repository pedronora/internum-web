<template>
  <div class="m-4">
    ...
    >
      <h1 class="text-2xl font-bold">Gestão de Empréstimos</h1>
    </div>
            ...
            >
              ...
              <td class="px-4 py-3 text-center whitespace-nowrap">
                <div v-if="l.status === 'requested'">
                  <button
                    class="mr-2 inline-flex items-center justify-center gap-1.5 rounded-lg bg-green-600 px-2.5 py-1 text-xs font-semibold text-white transition hover:bg-green-700 disabled:cursor-not-allowed disabled:opacity-60"
                    :disabled="loadingAction"
                    @click="approveRequest(l.id)"
                  >
                    <Icon name="check-circle" class="h-3.5 w-3.5" /> Aprovar
                  </button>
                  <button
                    class="inline-flex items-center justify-center gap-1.5 rounded-lg bg-red-600 px-2.5 py-1 text-xs font-semibold text-white transition hover:bg-red-700 disabled:cursor-not-allowed disabled:opacity-60"
                    :disabled="loadingAction"
                    @click="rejectRequest(l.id)"
                  >
                    <Icon name="x-circle" class="h-3.5 w-3.5" /> Rejeitar
                  </button>
                </div>
